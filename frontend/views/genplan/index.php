                ...
                <div class="my-image-box">
                    ...
                    <svg class="svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g class="svg__path">
                            ...
                            <image xlink:href="/img/genplan-pin.png" x="700" y="400" height="103" width="140"
                        ...
                        <a href="<?= Url::to(['genplan/view', 'section_number' => 151]) ?>">
                            <g class="svg__path">
                        ...
                        <a href="<?= Url::to(['genplan/view', 'section_number' => 152]) ?>">
                            <path class="svg__path"
                        ...
                        <a href="<?= Url::to(['genplan/view', 'section_number' => 153]) ?>">
                            <g class="svg__path">
                                <path class="svg__path"
                        ...
                        <a href="<?= Url::to(['genplan/view', 'section_number' => 154]) ?>">
                            <g class="svg__path">
                                <path class="svg__path"
