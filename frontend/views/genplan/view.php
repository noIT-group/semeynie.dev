                ...
                <?php if ($floorModels) : ?>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1715" height="925" viewBox="0 0 1715 925"
                        ...
                        <?php if (in_array($section_id, [151, 152])) : ?>
                            ...
                            <text x="430" y="98" class="section__pin pin-text2"><?= mb_strtolower(Yii::t('app', 'section_txt')) ?></text>
                        <?php else : ?>
                            <text x="735" y="50" class="section__pin pin-text3"><?= $section_number ?></text>
                            <text x="719" y="65" class="section__pin pin-text4"><?= mb_strtolower(Yii::t('app', 'section_txt')) ?></text>
                        <?php endif ?>
