...
?>
<div class="modal">
    <div class="remodal remodal-modal" data-remodal-id="modal__more">
        <button type="button" data-remodal-action="close" class="remodal-close"></button>

        <div class="remodal-modal-wrapper">
            <div class="modal__form">
                ...
                <div class="hidden">
                    <button type="submit"><?= Yii::t('app', 'get_more_info_txt') ?></button>
                </div>

                <div class="btn btn_beige modal__btn btn-send-handler"><?= Yii::t('app', 'get_more_info_txt') ?></div>
