...
use common\models\Genplan;
use kartik\grid\GridView;
use yii\helpers\Html;
use yii\web\View;

/* @var $this yii\web\View */
/* @var $searchModel backend\models\GenplanSearch */
...
$columns = [
    ...
    [
        ...
        'value' => function($model) {
            /** @var $model \common\models\Genplan */
    ...
    [
        ...
        'attribute' => 'status',
        'label' => 'Статус',
        'trueLabel' => Genplan::STATUS_ENABLE,
        'falseLabel' => Genplan::STATUS_DISABLE,
    ],
    [
