...
/* @var $model common\models\settings\AboutProjectSectionSettings */

$this->title = 'О застройщике -> О проекте';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['settings/about-project-section']];
    ...
    <div class="custom-form-section">
        ...
        <div class="custom-form-section-box">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col like-box">
                    <?php foreach($languages as $lang) : ?>
                        <?= $form->field($model, "teaser_{$lang}")->editor([
                            'settings' => [
                                'lang' => 'ru',
                                'minHeight' => 220,
