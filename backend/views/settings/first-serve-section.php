...
/* @var $model common\models\settings\FirstServeSectionSettings */

$this->title = 'О проекте -> Первая подача';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['settings/first-serve-section']];
