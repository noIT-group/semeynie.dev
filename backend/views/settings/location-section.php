...
/* @var $model common\models\settings\LocationSectionSettings */

$this->title = 'Расположение -> Содержимое';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['settings/location-section']];
