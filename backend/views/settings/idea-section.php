...
/* @var $model common\models\settings\IdeaSectionSettings */
/* @var $multiGalleryModel MultiGallery */

$this->title = 'Главная -> Идея';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['settings/idea-section']];
    ...
    <div class="custom-form-section">
        ...
        <div class="custom-form-section-box">
            ...
            <div class="row justify-content-between">
                <?php foreach($languages as $lang) : ?>
                    <div class="col like-box">
                        <?= $form->field($model, "title_summary_{$lang}")->editor([
                            'settings' => [
                                'lang' => 'ru',
                                'minHeight' => 260,
            ...
            <div class="row justify-content-between">
                <div class="col like-box">
                    ...
                    <?= GalleryManager::widget(
                        [
                            'model' => $multiGalleryModel,
                            'behaviorName' => 'multi-gallery',
                            'apiRoute' => 'multi-gallery/galleryApi'
                        ]
                    ) ?>
                </div>
            </div>
