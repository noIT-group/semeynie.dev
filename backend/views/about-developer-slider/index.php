...
use common\models\AboutDeveloperSlider;
use kartik\grid\GridView;
use yii\helpers\Html;

/* @var $this yii\web\View */
/* @var $searchModel backend\models\AboutDeveloperSliderSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$__params = require __DIR__ .'/__params.php';

$this->title = $__params['items'];
$this->params['breadcrumbs'][] = ['label' => $__params['items'], 'url' => ['about-developer-slider/index']];

$columns = [
    [
        'attribute' => 'name_ru',
        'format' => 'raw',
        'label' => 'Название слайда (RU)',
    ...
    [
        ...
        'attribute' => 'status',
        'label' => 'Статус',
        'trueLabel' => AboutDeveloperSlider::STATUS_ENABLE,
        'falseLabel' => AboutDeveloperSlider::STATUS_DISABLE,
    ],
    [
