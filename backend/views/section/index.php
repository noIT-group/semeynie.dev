...
$columns = [
    ...
    [
        'attribute' => 'queue_id',
        'format' => 'raw',
        'label' => 'Номер очереди (RU)',
        'value' => function($model) {
            return Html::a($model->queue->name_ru, ['update', 'id' => $model->id]);
        }
    ],
    [
        'attribute' => 'queue_id',
        'format' => 'raw',
        'label' => 'Номер очереди (UA)',
        'value' => function($model) {
            return Html::a($model->queue->name_ua, ['update', 'id' => $model->id]);
        }
    ],
    [
        ...
        'attribute' => 'status',
        'label' => 'Статус',
        'trueLabel' => Section::STATUS_ENABLE,
        'falseLabel' => Section::STATUS_DISABLE,
    ],
    [
