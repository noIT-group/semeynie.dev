...
/**
 * SliderAdvantageAboutController implements the CRUD actions for SliderAdvantage model.
 */
class SliderAdvantageAboutController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->where(['type' => 'about']);
